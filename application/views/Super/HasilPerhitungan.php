        ...
        <div class="card">
            <div class="row clearfix header">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 text-lg-right">
                    ...
                    <?=$this->uri->segment(2) == 'DetailPerhitungan'  ? 'class="active"' : '' ?><a  href="<?php echo base_url('SuperAdmin/DetailPerhitungan') ?>" style="border-radius: 8px;" class="btn btn-warning ml-3">Detail Perhitungan</a>
