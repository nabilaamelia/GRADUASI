                                ...
                                foreach($penerima as $prm) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" id="btn-hapus" class="btn btn-default btn-sm" title="Delete" href="<?php echo base_url().'SuperAdmin/hapus_Penerima/'.$prm['id_penerima_bantuan']; ?>" ><i class="fa fa-trash-o"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
