            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-sm-8 text-right">
                        <button type="button" data-toggle="modal" data-target="#Edit<?php echo $this->session->userdata('id_petugas'); ?> " style="border-radius: 8px;" class="btn btn-primary">Edit Profile</button>
