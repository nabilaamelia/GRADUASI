...
<div id="main-content">
        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 text-lg-right">
                    <a onclick="window.open(this.href); return false;" style="border-radius: 8px;" href="<?php echo base_url('SuperAdmin/PrintDetail/'.$id_periode)?>" class="btn btn-dark">Cetak Detail Perhitungan  <i class="fa fa-print"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-8">
        <div class="card">
            <div class="header">
                <h2><strong>Matrik Keputusan / Nilai Awal</strong></h2>
        ...
        <div class="col-lg-12 col-md-8">
            <div class="card">
                <div class="header">
                    <h2><strong>Matrik Ternormalisasi</strong></h2>
        ...
        <div class="col-lg-12 col-md-8">
            <div class="card">
                <div class="header">
                    <h2><strong>Nilai Preferensi</strong></h2>
        ...
        <div class="col-lg-12 col-md-8">
            <div class="card">
                <div class="header">
                    <h2><strong>Nilai Total Preferensi</strong></h2>
