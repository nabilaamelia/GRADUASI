                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#Edit<?php echo $prm['id_detail_periode']; ?>"  title="Edit"  ><i
                                                ...
                                                <button type="button" id="btn-hapus" class="btn btn-danger btn-sm" href="<?php echo base_url().'SuperAdmin/hapus_kuis/'.$prm['id_detail_periode']; ?>" title="Delete"><i
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo base_url(). 'SuperAdmin/tambah_kuis'?>" method='post' >
