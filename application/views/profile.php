        ...
        <div id="main-content">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo base_url(). 'Profile/EditProfil' ?>" method="post" enctype="multipart/form-data">  
            ...
            <div class="modal fade" id="UbahPass<?php echo $this->session->userdata('id_petugas'); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url(). 'Profile/UbahPass' ?>" method="post" enctype="multipart/form-data">  

                        <div class="form-group">
                            <label>Password Lama</label>
                            <input type="password" class="form-control" name="password_lama" id="password" required>
