                                        ...
                                        foreach($kriteria as $ktr) : ?>
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" id="btn-hapus" class="btn btn-danger btn-sm" title="Delete" href="<?php echo base_url('KriBo/hapus_datakri/'.$ktr['id_kriteria']) ?>" ><i class="fa fa-trash-o"></i></button>
                                                </td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="<?php echo base_url(). 'KriBo/tambah_aksi';
...
<div class="modal fade" id="Edit<?php echo $ktr['id_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="<?php echo base_url(). 'KriBo/edit_datakri/'.$ktr['id_kriteria'];
    ?>" method="post" enctype="multipart/form-data" >
...
<div class="modal fade" id="EditRentang<?php echo $ktr['id_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="<?php echo base_url(). 'KriBo/edit_datarentang/'.$ktr['id_kriteria'];
    ?>" method="post" enctype="multipart/form-data" >
