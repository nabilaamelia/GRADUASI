                            ...
                            <tbody>
                                ...
                                foreach($penerima as $prm) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-default btn-sm" href="<?php echo base_url() ?>DtKuisioner/Edit/<?php echo $prm['id_detail_periode']?>" title="Edit"  ><i
                                                class="fa fa-pencil" ></i></a>


                                                <button type="button" id="btn-hapus" class="btn btn-default btn-sm" href="<?php echo base_url().'DtKuisioner/hapus_kuis/'.$prm['id_detail_periode']; ?>" title="Delete"><i
